...
export function TripDetailContent({ tripId }: TripDetailContentProps) {
  ...
  const getExpenseParticipantsMeta = (
    ...
    const participantsCount = calculateExpenseParticipantsCount({
      scope,
      participantsCount: explicitParticipantsCount,
      tripMembersCount: tripMembers.length,
    });
...
type ExpenseAccordionBadgeTone = "default" | "success" | "warning" | "danger";

type ExpenseAccordionRow = {
  id: string;
  title: string;
  summary: string;
  subtotal: number;
  isFree?: boolean;
  badges?: Array<{ label: string; tone?: ExpenseAccordionBadgeTone }>;
  details: Array<{ label: string; value: React.ReactNode; highlight?: boolean }>;
